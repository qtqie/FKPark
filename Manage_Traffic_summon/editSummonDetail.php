...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'save') {
        ...
        $sql = "INSERT INTO trafficsummonsrecords (vehicle_plate, vehicle_type, violation_type, datetime, description, demerit_point)
                VALUES (?, ?, ?, ?, ?, ?)";
        ...
        $sql = "DELETE FROM trafficsummonsrecords WHERE vehicle_plate = ?";
        $stmt = $conn->prepare($sql);
