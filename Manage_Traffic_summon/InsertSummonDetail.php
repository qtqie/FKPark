...
$vehiclePlate = $vehicleType = $violationType = $datetime = $description = $demeritPoint = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $action = isset($_POST['create']) ? 'create' : (isset($_POST['edit']) ? 'edit' : '');
    
    if ($action == 'edit') {
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO trafficsummonsrecords (vehicle_plate, vehicle_type, violation_type, datetime, description, demerit_point) VALUES (?, ?, ?, ?, ?, ?)");
