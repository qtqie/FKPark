  ...
  <ul>
    ...
    <li class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="approveRegistration.blade.php">Approve Registration</a>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>PKA6654</td>
                <td>Car</td>
                <td><p><a href="QR.php"><button>Approve</button></a></p></td>
                <td><p><a href="mailto:nurfqhah@gmail.com?subject=Hello&body=Thank you,Here is your sticker"><button>Contact</button></a></p></td>
            </tr>
            <tr>
                <td>Qistina Aimuni binti Harun</td>
                <td>VF5543</td>
                <td>B4BY</td>
                <td>Car</td>
                <td><p><a href="QR.php"><button>Approve</button></a></p></td>
