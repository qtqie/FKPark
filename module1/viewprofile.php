  ...
  <table>
    ...
    <?php
      ...
      foreach ($registration as $reg) {
          ...
          echo "<td>" . $reg['user_pw'] . "</td>";
          echo "<td>" . $reg['vehicle_plate'] . "</td>";
          echo "<td>" . $reg['vehicle_type'] . "</td>";
          echo "<td>" . $reg['user_id'] . "</td>";
          echo "<td>" . $reg['user_email'] . "</td>";
          echo "<td>" . $reg['user_type'] . "</td>";
          echo "<td>" . $reg['user_address'] . "</td>";
          echo "<td><a href='editprofile.php'><button>Edit</button></a></td>";
          echo "</tr>";
      }
      ?>
    </tbody>
