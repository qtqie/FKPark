...
<article>
  ...
  <div class="profile-picture">
    <img src="https://lh3.googleusercontent.com/proxy/tBwhlAW_OOVvrl9MQlDoqTRr4Sh4n7IW4XKchhOXMqGJFhnENTXuDad0dyNPTJ3JhlIoulhWJy5apAAIwARRemObRrDhU2keompBfalGLIbT7hzsR2I" alt="Profile Picture">
  </div>

  <form action="edit_user_profile.php" method="post" enctype="multipart/form-data">
    <label for="name">Name:</label>
    <input type="text" id="name" name="name" value="Ali bin Abu" required>
