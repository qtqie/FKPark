...
<title>Record traffic summon</title>
<style>
* {
...
<section>
   <article>
    <form action="#" method="post">
      ...
      <input type="text" id="name" name="ViolationType">
      </div>
      <br>
      ...
      <button type="button" onclick="printSummon()">Print Summon</button>
      </div>
      <br>
